  ...
  return (
    <html lang="es" suppressHydrationWarning>
      <body className={`${encodeSans.variable} font-sans antialiased`}>
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:absolute focus:left-4 focus:top-4 focus:z-[100] focus:rounded-md focus:bg-pba-purple focus:px-4 focus:py-2 focus:text-white focus:shadow-lg"
        >
