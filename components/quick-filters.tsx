...
const COLORS: Record<QuickFilterKey, string> = {
  cerradas: "text-red-600 bg-red-500/15 border-red-500/30 hover:bg-red-500/25",
  contexto: "text-red-600 bg-red-500/15 border-red-500/30 hover:bg-red-500/25",
  sin_fed: "text-amber-400 bg-amber-500/15 border-amber-500/30 hover:bg-amber-500/25",
  sin_contacto: "text-orange-400 bg-orange-500/15 border-orange-500/30 hover:bg-orange-500/25",
      ...
      {QUICK_FILTERS.map(({ key, label }) => {
        ...
        return (
          ...
          >
            ...
            {label}
            {count !== undefined && (
              <span className="ml-0.5 rounded-full bg-card/60 px-1.5 text-[10px] font-semibold">
