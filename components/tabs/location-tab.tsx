...
export function LocationTab({ establecimiento }: { establecimiento: Establecimiento }) {
  ...
  return (
    <div className="space-y-6 py-4">
      ...
      {hasCoordinates ? (
        <div className="overflow-hidden rounded-lg border border-slate-200 dark:border-border shadow-sm" style={{ height: "420px" }}>
          <LocationMap
      ...
      <div className="flex items-start gap-2 rounded-lg bg-slate-50 dark:bg-surface-subtle p-4">
